...
import           Text.Megaparsec                         (label, ParseError, ParseErrorBundle (ParseErrorBundle), SourcePos,
                                                          attachSourcePos, bundleErrors, bundlePosState, eof,
                                                          errorOffset, parseErrorPretty, runParser)
import           Text.Megaparsec.Char                    (space)

request :: Parser GQLQueryRoot
request = dbg "request" $ label "GQLQueryRoot" $ do
